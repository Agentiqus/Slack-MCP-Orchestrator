...
A thin stdio MCP server that connects AI tools (Cursor, Claude Desktop) to Slack through the [MCP Orchestrator](https://github.com/agentiqus/slack-mcp-orchestrator).
  ...
  "mcpServers": {
    "slack": {
      ...
      "env": {
        ...
        "MCP_API_URL": "https://<YOUR_HOSTED_URL>/api/mcp"
      }
    }
  }
}
